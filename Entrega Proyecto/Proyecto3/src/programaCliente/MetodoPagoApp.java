...
public class MetodoPagoApp extends JPanel {

	private NavegadorApp nav;
	...
	public MetodoPagoApp(String nombreClasePasarela, String nombrePasarela, NavegadorApp navegador, Callable<Void> callback)
